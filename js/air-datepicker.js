!function (e, t) {
    ...
    return function () {
        ...
        function m(e, t, i) {
            let s = v(e, !1).getTime(), a = v(t, !1).getTime();
            return i ? s >= a : s > a
        }
        ...
        class _ {
            ...
            _createElement() {
                let {year: e, month: t, date: i} = o(this.date), s = this.customData?.attrs || {};
                this.$cell = n({
                    className: this._getClassName(),
                    attrs: {"data-year": e, "data-month": t, "data-date": i, ...s}
                })
            }

            _getClassName() {
                let e = new Date, {selectOtherMonths: t, selectOtherYears: s} = this.opts, {
                        minDate: a,
                        maxDate: n
                    } = this.dp, {day: r} = o(this.date), h = this._isOutOfMinMaxRange(), l = this.customData?.disabled,
                ...
                switch (this.type) {
                    ...
                    case i.months:
                        ...
                        break;
                    case i.years:
                        c = u({"-other-decade-": this.isOtherDecade, "-disabled-": h || this.isOtherDecade && !s || l})
                }
                return u(d, c, this.customData?.classes)
            }

            _getHtml() {
                let {year: e, month: t, date: s} = o(this.date), {showOtherMonths: a, showOtherYears: n} = this.opts;
        ...
        class F {
            ...
            _getDaysCells() {
                ...
                }(n, l), u = i + l + d, p = c.getDate(), {year: m, month: g} = o(c), v = 0;
                for (; v < u;) {
            ...
            constructor(e, t) {
                ...
                if (P(this, "viewIndexes", [i.days, i.months, i.years]), P(this, "next", (() => {
                    ...
                    let i, s, {isMobile: a} = r.opts, n = r.$el.getBoundingClientRect(),
                        ...
                        p = window.scrollX, m = r.opts.offset, g = c[0], v = c[1];
